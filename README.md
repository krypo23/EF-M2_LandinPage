...
🔗 **[Ver Demo en Vivo](https://krypo23.github.io/EF-M2_LandinPage/)**
...
Al ser un proyecto estático puro, la ejecución local es directa:

1. Clona este repositorio:
   ```bash
   git clone [https://github.com/krypo23/EF-M2_LandinPage.git](https://github.com/krypo23/EF-M2_LandinPage.git)